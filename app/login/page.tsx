...
export default function LoginPage() {
  ...
  const isFormValid = email && validateEmail(email) && password && !loading;
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                Track, manage, and optimize all your recurring payments in one organized place. Never miss a renewal or overspend again.
              </p>
            </div>
            <div className="space-y-6 pt-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-base font-medium text-gray-900 dark:text-gray-100 mb-1">Centralized tracking</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">See all your subscriptions in one dashboard</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 mt-1">
                ...
                <div>
                  <h3 className="text-base font-medium text-gray-900 dark:text-gray-100 mb-1">Renewal reminders</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Get notified before subscriptions renew</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 mt-1">
                ...
                <div>
                  <h3 className="text-base font-medium text-gray-900 dark:text-gray-100 mb-1">Spending insights</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Understand your monthly subscription costs</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Sign in to manage your subscriptions and track your spending.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <button
              ...
              className="w-full flex justify-center items-center py-2.5 px-4 border border-transparent text-sm font-medium rounded-lg text-black bg-gray-900 dark:bg-gray-100 hover:bg-gray-800 dark:hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 dark:focus:ring-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
              {loading ? (
